...
export const fetchCurrentWeather = async (apiKey: string, location: string = 'berlin'): Promise<CurrentWeather> => {
...
export const fetchWeeklyForecast = async (apiKey: string, location: string = 'berlin'): Promise<WeatherData[]> => {
  const response = await fetch(
